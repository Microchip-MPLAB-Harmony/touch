/*============================================================================
Filename : qtm_acq_4p_pic32cmgc_0x0054_api.h 
Project  : Touch Modular Library
Purpose  : Acquisition module - PIC32CM_GC00
         : Header file for application project - Acquisition library API
============================================================================*/

#ifndef TOUCH_API_PIC32CMGC_ACQ_4P_H__
#define TOUCH_API_PIC32CMGC_ACQ_4P_H__
...
typedef struct
{
  uint64_t grp4_x_mask[4];	/* Selects the X Pins for this parallel node group */
  uint64_t grp4_ymask;	/* Selects the Y Pins for this parallel node group */
...
}qtm_acq_4p_pic32cm_node_config_t;
...
typedef struct
{
  ...
  qtm_acq_4p_pic32cm_node_config_t *qtm_acq_node_config;
