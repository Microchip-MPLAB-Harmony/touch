...
"""
class classTouchGesture():
    def enableGestureFiles(self,symbol,event):
        """Enables Gesture source / library files.
        Arguments:
    ...
    #### Components ####
    ################################################################################
    def initGestureInstance(self,qtouchComponent, touchMenu):
        """Initialise Gesture symbol Instance
        Arguments:
        ...
        enableGestureMenu.setDependencies(self.enableGestureFiles,["ENABLE_GESTURE"])

        gestureMenu = qtouchComponent.createMenuSymbol("GESTURE_MENU", enableGestureMenu)
        gestureMenu.setLabel("Gesture Configuration")
        
        self.setTapMenu(qtouchComponent,enableGestureMenu)
        self.setSwipeMenu(qtouchComponent,enableGestureMenu)
        self.setWheelMenu(qtouchComponent,enableGestureMenu)
        self.setPinchAndZoomMenu(qtouchComponent,enableGestureMenu)


    def setTapMenu(self,qtouchComponent,enableGestureMenu):
        """Initialise Gesture tap Menu symbols
        Arguments:
            :qtouchComponent : touchModule
            :enableGestureMenu : parent menu symbol
        Returns:
            :none
        """
        ...
        #Swipe
    def setSwipeMenu(self,qtouchComponent,enableGestureMenu):
        """Initialise Gesture Swipe Menu symbols
        Arguments:
            :qtouchComponent : touchModule
            :enableGestureMenu : parent menu symbol
        Returns:
    ...
    def setWheelMenu(self,qtouchComponent,enableGestureMenu):
        """Initialise Gesture Wheel Menu symbols
        Arguments:
            :qtouchComponent : touchModule
            :enableGestureMenu : parent menu symbol
        Returns:
    ...
    def setPinchAndZoomMenu(self,qtouchComponent,enableGestureMenu):
        """Initialise Gesture pinch and zoom Menu symbols
        Arguments:
            :qtouchComponent : touchModule
            :enableGestureMenu : parent menu symbol
        Returns:
