...
#### Components ####
################################################################################
def initGestureInstance(qtouchComponent, touchMenu):
    ...
    setTapMenu(qtouchComponent,enableGestureMenu)
    setSwipeMenu(qtouchComponent,enableGestureMenu)
    setWheelMenu(qtouchComponent,enableGestureMenu)
    setPinchAndZoomMenu(qtouchComponent,enableGestureMenu)


def setTapMenu(qtouchComponent,enableGestureMenu):
    ...
    #Swipe
def setSwipeMenu(qtouchComponent,enableGestureMenu):
...
def setWheelMenu(qtouchComponent,enableGestureMenu):
...
def setPinchAndZoomMenu(qtouchComponent,enableGestureMenu):
