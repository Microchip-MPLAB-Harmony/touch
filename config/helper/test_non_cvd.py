...
def validate_json(data):
    ...
    mandatory_properties = [
        {"features":["core","module_id","self","mutual","scroller","surface","gesture","frequency_hop","frequency_hop_auto","low_power_software","low_power_event","lump_mode","boost_mode","wake_up","trust_zone"]},
        ...
        {"version_data":[{"features":["hardware_shield","timer_shield","csd","ptc_prescaler"]},{"node":["ptc_clock_range","series_resistor"]}]}
    ]
    ...
    conditions = [
        (('version_data','features', 'ptc_prescaler'), True, 'version_data.node.ptc_prescaler', ["component_values","default_index"]),
        (('version_data','features','csd'),True,'version_data.node.csd',['min','max','default']),
