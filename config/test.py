...
def validate_json(data):
    ...
    mandatory_properties = [
        {"features":["core","module_id","self","mutual","hardware_shield","timer_shield","csd","scroller","surface","gesture","frequency_hop","frequency_hop_auto","low_power_software","low_power_event","lump_mode","boost_mode"]},
    ...
    conditions = [
        (('features', 'core'), 'PTC', 'node.ptc_prescaler', ["component_values","default_index"]),
        ...
        (('features','timer_shield'),True,"driven_shield",[]),
    ...
    if "driven_shield" in data and data["features"]["timer_shield"]==True:
...
def main():
    ...
    try:
        ...
        with open(json_folder+'/'+file_name+'.json', 'r') as file:
            data = json.load(file)
