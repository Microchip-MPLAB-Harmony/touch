...
tchDataStreamerHeaderFile.setDestPath("/qtouch/datastreamer/")
tchDataStreamerHeaderFile.setProjectPath("config/" + configName + "/qtouch/datastreamer/")
...
tchDsHeaderFileDb.setDestPath("/qtouch/datastreamer/")
tchDsHeaderFileDb.setProjectPath("config/" + configName + "/qtouch/datastreamer/")
...
tchDsHeaderFileDs.setDestPath("/qtouch/datastreamer/")
tchDsHeaderFileDs.setProjectPath("config/" + configName + "/qtouch/datastreamer/")
...
tchDsHeaderFileSc.setDestPath("/qtouch/datastreamer/")
tchDsHeaderFileSc.setProjectPath("config/" + configName + "/qtouch/datastreamer/")
...
tchDataStreamerSourceFile.setDestPath("/qtouch/datastreamer/")
tchDataStreamerSourceFile.setProjectPath("config/" + configName + "/qtouch/datastreamer/")
