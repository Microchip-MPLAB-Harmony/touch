...
"""
def initDataStreamer(configName, qtouchComponent, parentLabel):
    """
    ...
    fileList = []
    fileList.append(setDatastreamerHeader(configName, qtouchComponent))
    fileList.append(setDatastreamerDb(configName, qtouchComponent))
    fileList.append(setDatastreamerDs(configName, qtouchComponent))
    fileList.append(setDatastreamerSc(configName, qtouchComponent))
    fileList.append(setDatastreamerSource(configName, qtouchComponent))
    return fileList


# Header File
def setDatastreamerHeader(configName, qtouchComponent):
    """
...
# Header File2
def setDatastreamerDb(configName, qtouchComponent):
    """
...
# Header File3
def setDatastreamerDs(configName, qtouchComponent):
    """
...
# Header File4
def setDatastreamerSc(configName, qtouchComponent):
    """
...
# Source File
def setDatastreamerSource(configName, qtouchComponent):
    """
