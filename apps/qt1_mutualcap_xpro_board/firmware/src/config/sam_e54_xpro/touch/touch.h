...
{                                                                                                                  \
   X(31), Y(25), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   X(24), Y(25), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   X(30), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   X(0), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   X(31), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_5_PARAMS                                                                                               \
{                                                                                                                  \
   X(24), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_6_PARAMS                                                                                               \
{                                                                                                                  \
   X(30), Y(5), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_7_PARAMS                                                                                               \
{                                                                                                                  \
   X(0), Y(5), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_8_PARAMS                                                                                               \
{                                                                                                                  \
   X(31), Y(5), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
	
#define NODE_9_PARAMS                                                                                               \
{                                                                                                                  \
   X(24), Y(5), 10, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16\
}
